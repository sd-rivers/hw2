...
library(tidymodels)
library(tidyverse)
setwd("C:\\Users\\Dmitri\\Downloads\\hw2")
...
median(abalone$age)
```
The distribution of abalone is right skewed with the majority centered around 10.5.
...
We shouldn't use rings to predict age because age is a transformation of rings.
...
new_data = data.frame(type = "F", longest_shell = 0.5, diameter = 0.1,
...
Roughly 55% of the proportion of the variance for price is explained by our predictors and model.
